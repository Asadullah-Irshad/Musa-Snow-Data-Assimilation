# Musa-Snow-Data-Assimilation

MuSA — ensemble-based snow data assimilation coupling the FSM2 model with Bayesian filters and smoothers. Based on Alonso-González et al. (2022).
...
![Figure 1](Img/PBS_animation.gif)
...
### Built with
- **Python** — core codebase (numpy, pandas, scipy, netCDF4, mpi4py)
- **Fortran** — the FSM2 snow model (`.F90` source)
- **Bash** — run and compile scripts (PBS/Slurm arrays)
- **netCDF** — meteorological forcing and observation data format
